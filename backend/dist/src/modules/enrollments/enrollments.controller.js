...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Enroll in a published course' }),
    (0, swagger_1.ApiResponse)({ status: 201, type: enrollment_entity_1.EnrollmentEntity }),
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Get all my enrolled courses' }),
