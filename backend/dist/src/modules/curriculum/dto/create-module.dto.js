...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Title of the module', example: 'Introduction to UI Design' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)(),
    __metadata("design:type", String)
], CreateModuleDto.prototype, "title", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Order of the module in the course', example: 1 }),
