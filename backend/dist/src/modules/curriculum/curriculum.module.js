...
exports.CurriculumModule = CurriculumModule = __decorate([
    (0, common_1.Module)({
        controllers: [modules_controller_1.ModulesController, lessons_controller_1.LessonsController],
        providers: [modules_service_1.ModulesService, lessons_service_1.LessonsService],
    })
], CurriculumModule);
